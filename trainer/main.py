...
#     "prediction_file",
#     "./forests.tfrecord",
#     "Tfrecords for which to make predictions")
#
# flags.DEFINE_integer(
...
#     if mode == ModeKeys.EVAL or mode == ModeKeys.INFER:
#         num_epochs = 1
#
...
#     cxt_features['label'] = tf.FixedLenFeature(shape=[], dtype=tf.int64)
#
#     context_parsed, sequence_parsed = tf.parse_single_sequence_example(
#         example,
#         context_features=cxt_features,
#         sequence_features={
...
#     print(response)
#
#     for p in estimator.predict_proba(input_fn=get_input_fn(FLAGS.train_data, ModeKeys.INFER, 1), as_iterable=True):
#         print(p)
#
