...
def feature_columns():
    ...
    return [
        ...
        tf.contrib.layers.real_valued_column("tmax", dtype=tf.float32),
        tf.contrib.layers.real_valued_column("prcp", dtype=tf.float32),
    ...
    def get_experiment(output_dir):
        ...
        serving_input_fn = (
            input_fn_maker.build_parsing_transforming_serving_input_fn(
                ...
                transform_savedmodel_dir=args.transform_savedmodel,
